...
Processing and Generating a Tidy Dataset
==========================================

* This is the course project for the Getting and Cleaning Data Coursera course by John Hopkins University.
* The R file uploaded, `run_analysis.R`, performs the following steps:
